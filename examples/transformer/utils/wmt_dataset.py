...
from examples.transformer.utils import tokenizer
...
def download_and_preprocess_dataset(raw_dir, data_dir, search):
    ...
    train_files = get_raw_files(raw_dir, _TRAIN_DATA_SOURCES)
    eval_files = get_raw_files(raw_dir, _EVAL_DATA_SOURCES)
